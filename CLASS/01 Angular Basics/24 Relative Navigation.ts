/*
Relative navigation allows us to add some flexibility to our navigation so that if we edit the route path in the routing module, our app will not break and we will not need to go back to make the changes everywhere in the app where we are using that specific route
*/
